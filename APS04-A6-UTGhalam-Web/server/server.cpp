...
ShowFile::ShowFile(const string& filePath, const string& fileType, shared_ptr<System> sys)
    : filePath_(filePath),
      fileType_(fileType),
      system_(sys) {}
...
ShowPage::ShowPage(const string& filePath, shared_ptr<System> sys)
    : ShowFile(filePath, "text/" + utils::getExtension(filePath), sys) {}

ShowImage::ShowImage(const string& filePath, shared_ptr<System> sys)
    : ShowFile(filePath, "image/" + utils::getExtension(filePath), sys) {}
